...
class TimeAgo private constructor() {
    ...
    private enum class Periods(val propertyKey: String, private val predicate: DistancePredicate) {
                ...
                when (foundTimePeriod) {
                    ...
                    TimeAgo.Periods.XMONTHS_FUTURE -> {
                        ...
                        val yMonthsText = if (months1 == 12)
                            ...
                            handlePeriodKeyAsPlural(resources, "ml.timeago.aboutamonth.future", periodKey, months1)
